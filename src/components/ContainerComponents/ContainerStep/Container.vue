      ...
      <template>
        <v-container fluid>
          <v-row align="center">
            ...
            <v-col
              v-if="geteditedOrSavedClaimContainer.damage_caused_by != ''"
    ...
    initialize() {
      ...
      if (this.geteditedOrSavedClaimContainer.id > 0) {
        this.EquipmentModel.categorie_of_equipment =
          this.geteditedOrSavedClaimContainer.categorie_of_equipment;

        this.EquipmentModel.brand.id =
          this.geteditedOrSavedClaimContainer.brand.id;
        ...
        this.EquipmentModel.equipement_registration =
          this.geteditedOrSavedClaimContainer.equipement_registration;
