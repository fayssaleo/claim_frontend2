      ...
      <template>
        ...
        <v-stepper v-model="e1">
          ...
          <div class="d-flex">
                ...
                <v-btn v-else color="gray" class="mx-4" @click="stepper_backward(e1)" > backward </v-btn>
              ...
              <v-btn v-else color="primary" @click="stepper_forward(e1)">
                ...
                <v-btn
                  color="ma-2 teal white--text"
                  @click="editedOrSavedClaim()"
                >
                  save
                </v-btn>
    ...
    methods: {
      initialize() {
        if (this.geteditedOrSavedClaimAutomobile.id > 0) {
          ...
          if (this.geteditedOrSavedClaimAutomobile.ClaimOrIncident=="Incident") {
            this.switch1 = true;
          } else {
            this.switch1 = false;
          }
      ...
      ...mapActions(["set_ClaimOrIncident_claim_SetterAction","editedOrSavedAutomobileClaimAction"]),
      ...
      stepper_backward() {
        if (this.geteditedOrSavedClaimAutomobile.damage_caused_by == "Thirdparty") {
          if (this.e1 == 3) {
